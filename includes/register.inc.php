...
if (isset($_POST['teamname'], $_POST['email'], $_POST['p'],$_POST['mobile'],$_POST['bloodgroup'],$_POST['role'],$_POST['city'],$_POST['gender'])) {
   ...
   // check existing email  
    ...
    if (empty($error_msg)) {
        ...
        if ($insert_stmt = $mysqli->prepare("INSERT into members SET teamname='$teamname', email='$email', password ='$password',mobile ='$mobile', bloodgroup='$bloodgroup',role='$role',city='$city', gender='$gender' ")) {
