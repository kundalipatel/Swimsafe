        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="donoraccount.php" class="dropdown-toggle"  aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>My account</a>
                    </li>

                                       <li class="menu-item-has-children dropdown">
                        <a href="logout.php" class="dropdown-toggle"  aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Logout</a>
                    </li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    ?>-->
                       <div class="card" style="height:450px; width:500px;">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                 <!-- <select data-placeholder="Select your blood group" class="standardSelect" tabindex="1">-->
                                   <select  data-placeholder= "Select your blood group"  id="select" class="form-control" >
                                    <option value=""></option>
                                ...
                                <div class="form-group">
                                    <label class=" form-control-label"> Time until next donation</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="material-icons">alarm_on</i></div>
                                        <input class="form-control">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-home" style="font-size: 24px" ></i></div>
                                                <input class="form-control">
                                    </div>
                                    <small class="form-text text-muted">Enter your City</small>
                                </div>
                               
                                <div class="form-group">
                                    <label class=" form-control-label"></label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="material-icons">place</i></div>
                                        <input class="form-control">
                                    </div>
                                    <small class="form-text text-muted"></small>
                                </div>
            ...
            <div class="col-xl-6">
                <p><strong>Blood donors needed</strong></p>
                <img  style="width:1024px; height:512px;" alt="" src="images/11.jpg">
                        </div>
           <div class="col-xl-6 col-xl-6">
                <section class="card">
                    <div class="twt-feed blue-bg">
                        ...
                        <div class="media">
                            <a href="#">
                                <img class="align-self-center rounded-circle mr-3" style="width:85px; height:85px;" alt="" src="images/add.png">
                            </a>
                            <div class="media-body">
                                <h2 class="text-white display-6">Harry Stuart</h2>
            ...
            <div class="col-xl-3 col-xl-6">
                <div class="card" style="width: 27em;">
                    ...
                    <div class="Vector-map-js">
                        <div id="vmap" class="vmap" style="height: 230px;"></div>
                    </div>
                </div>
                <!-- /# card -->
            </div>
