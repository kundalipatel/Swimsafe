    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
     ...
     <select name="select" id="select" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Email" type="text" name="admin-user" required>
                        </div>
                        <div class="form-group">
					...
					<?php
						...
						$result=mysqli_query($con,"SELECT * FROM admin_info WHERE admin_user='$admin_user' AND admin_password='$password'")or die (mysqli_error());
						 if(!$result){
